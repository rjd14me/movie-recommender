...
def startup_event():
    ...
    if model_path.exists():
        ...
        deep_recommender = DeepRecommender.load_from_file(
            model_path, movies_with_stats
        )
...
def search_titles(q: str, limit: int = 5):
    ...
    if "imdb_url" in matches.columns:
        cols.append("imdb_url")
